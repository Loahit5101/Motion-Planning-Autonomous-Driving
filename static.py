...
if __name__ == '__main__':
    ...
    # VEHICLE 1 SPAWN
    spawn_point1 = carla.Transform(carla.Location(x=2.3, y=140, z=0.3), carla.Rotation(yaw=-90))
    ...
    # VEHICLE 2 SPAWN
    spawn_point2 = carla.Transform(carla.Location(x=6.3, y=120, z=0.3), carla.Rotation(yaw=-90))
    ...
    # VEHICLE 3 SPAWN
    spawn_point4 = carla.Transform(carla.Location(x=1.3, y=100, z=0.3), carla.Rotation(yaw=-90))
    ...
    # EGO VEHICLE SPAWN
    spawn_point3 = carla.Transform(carla.Location(x=2.3, y=160, z=0.3), carla.Rotation(yaw=-90))
    ...
    plt.plot([start.transform.location.x],[start.transform.location.y],marker = 9)
    plt.text(start.transform.location.x,start.transform.location.y,"Start")
    
    plt.plot([goal.transform.location.x],[goal.transform.location.y],marker = 9)
